...
from utils import temp, get_size, get_duration
...
async def api_actor_search_handler(req):
    ...
    results_list = [{
        ...
        # 🎞️ वीडियो की लंबाई ("2:14:09"); नॉन-वीडियो/पुरानी फाइलों पर ""
